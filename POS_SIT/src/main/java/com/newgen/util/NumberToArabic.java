...
public class NumberToArabic {
	...
	{
		BigDecimal requested_amt_big=new BigDecimal("1500000");
		NumberToArabic n=new NumberToArabic();
		System.out.println("Result is"+n.convertToArabic(requested_amt_big,"SAR"));
	}
	*/
	/**
	 * BHD - not implemented
	...
	private static String[] arabicOnes =
     ...
     private static String[] arabicAppendedTwos =
         new String[] {
         "مئتا", "ألفا", "مليونان", "مليارا", "تريليونا", "كوادريليونا", "كوينتليونا", "سكستيليونا"
     };
     ...
     private static String[] arabicGroup =
         new String[] {
         "مائة", "ألف", "واحد مليون", "مليار", "تريليون", "كوادريليون", "كوينتليون", "سكستيليون"
     };

     private static String[] arabicAppendedGroup =
         new String[] {
         "", "ألفاً", "	مليونان", "ملياراً", "تريليوناً", "كوادريليوناً", "كوينتليوناً", "سكستيليوناً"
     };
